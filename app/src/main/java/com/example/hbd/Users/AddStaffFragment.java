...
public class AddStaffFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adminstaffname = V.findViewById(R.id.uusername123);
        adminstaffemail = V.findViewById(R.id.useremail123);
        adminstaffpassword = V.findViewById(R.id.userpassword123);
        adminstaffostate = V.findViewById(R.id.userostate123);
        adminstafforg = V.findViewById(R.id.useruhos123);
        addadminstaff = V.findViewById(R.id.adduserdataBtn1);
